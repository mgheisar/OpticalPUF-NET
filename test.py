...
import os
import time
from utils import PairLoader_large2, BalanceBatchSampler_large, Reporter, query_partitioning, acc_authentication
...
if __name__ == '__main__':
    ...
    train_dataset = PairLoader_large2(partition['train'], labels_train)
    test_dataset = PairLoader_large2(partition['test'], labels_test)
    validation_dataset = PairLoader_large2(partition['validation'], labels_validation)
    #  --------------------------------------------------------------------------------------
    ...
    if start:
        ...
        Ptp01, Ptp001 = acc_authentication(new_path, enrolled_loader['validation'], H1_loader['validation'],
                                           H0_loader['validation'], arg_in)
